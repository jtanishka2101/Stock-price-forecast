...
# --------------------------------------------------------
# 1. Load your stock data and clean the index
# --------------------------------------------------------
...
# --------------------------------------------------------
# 2. Visual diagnostics: Plot ACF and PACF for ARIMA params
# --------------------------------------------------------
...
# --------------------------------------------------------
# 3. Fit ARIMA model (order = (1,1,1) as a starting point)
# --------------------------------------------------------
...
# --------------------------------------------------------
# 4. Forecast the next 10 closing prices using the ARIMA model
# --------------------------------------------------------
...
# --------------------------------------------------------
# 5. Plot actual close prices and ARIMA forecasts on the same chart
# --------------------------------------------------------
plt.figure(figsize=(10, 6))
plt.plot(stock_data['Close'], label='Actual')
forecast_index = pd.date_range(stock_data.index[-1], periods=11, freq='B')[1:]
